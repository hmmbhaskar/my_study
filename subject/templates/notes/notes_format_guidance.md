...
### Key Info: Any Info which is really important

### Bits: An info which is amusing, sarcastic, and such. It can be unique interesting things as well. 

### Foundational Concepts & Core Principles [alias Foundation]: Main Core Information

### Topic X

- Example Topics: [Commands, Shortcuts]  # Noted so that in case of such topics can remember to make them main topic. 
